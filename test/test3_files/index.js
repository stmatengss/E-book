...
function addComment(num){
	...
	if (false) {
    	...
    	max += 1;
    	var templates = '<div class="comment-all"><div style="float:left; width:28px; height: 14px; "><sub style="font-size:14px;">${num}</sub></div>' +
...
//    		'<p class="comment-item item" data-lid="${lid}" style="text-indent:${dist}"><a><sup>${num}</sup>${text}</a></p>';
    	...
    	var images =
    	    '<div class="comment-all"><div style="float:left; width:28px; height: 14px; "><sub style="font-size:14px;">${num}</sub></div>\
