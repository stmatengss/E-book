...
$(function(){
	...
	$('.input-panel.input-left .send').on('click', function(e){
		...
		if(seq.changed){
			...
			$element.append(" <sub>"+seq.value_str+"</sub>");
	...
	$('.input-panel.input-right .send').on('click', function(e){
		...
		$newElement.css("margin-bottom", "52px");
	...
	//mouse move event
	$('.container .label').on('mouseenter',function(e){
...
function addComment(num){
	...
	$('.comment .comment-item:last').css("margin-bottom", "52px");
